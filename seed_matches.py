...
ko_data = [
    ('round_of_32', '2026-06-28 17:00:00', '1º A vs 3º C/D/E', 'SoFi Stadium', 'Los Angeles'),
    ('round_of_32', '2026-06-28 20:00:00', '2º A vs 2º B', 'Estadio Azteca', 'Mexico City'),
    ('round_of_32', '2026-06-29 17:00:00', '1º B vs 3º A/C/D', 'BC Place', 'Vancouver'),
    ('round_of_32', '2026-06-29 20:00:00', '1º C vs 3º A/B/F', 'Gillette Stadium', 'Boston'),
    ('round_of_32', '2026-06-30 17:00:00', '1º D vs 3º B/E/F', 'MetLife Stadium', 'New Jersey'),
    ('round_of_32', '2026-06-30 20:00:00', '2º C vs 2º D', 'NRG Stadium', 'Houston'),
    ('round_of_32', '2026-07-01 17:00:00', '1º E vs 3º A/D/G', 'AT&T Stadium', 'Dallas'),
    ('round_of_32', '2026-07-01 20:00:00', '1º F vs 2º E', 'BMO Field', 'Toronto'),
    ('round_of_32', '2026-07-02 17:00:00', '1º G vs 3º C/F/I', 'Mercedes-Benz Stadium', 'Atlanta'),
    ('round_of_32', '2026-07-02 20:00:00', '2º F vs 2º G', 'Arrowhead Stadium', 'Kansas City'),
    ('round_of_32', '2026-07-03 17:00:00', '1º H vs 2º I', 'Hard Rock Stadium', 'Miami'),
    ('round_of_32', '2026-07-03 20:00:00', '1º I vs 3º G/H/J', 'Levi\'s Stadium', 'San Francisco'),
    ('round_of_32', '2026-07-04 17:00:00', '1º J vs 2º K', 'Estadio BBVA', 'Monterrey'),
    ('round_of_32', '2026-07-04 20:00:00', '1º K vs 3º I/L', 'Lumen Field', 'Seattle'),
    ('round_of_32', '2026-07-05 17:00:00', '1º L vs 2º J', 'Estadio Akron', 'Guadalajara'),
    ('round_of_32', '2026-07-05 20:00:00', '2º L vs 2º H', 'Lincoln Financial Field', 'Philadelphia'),
    
    ('round_of_16', '2026-07-06 17:00:00', 'Venc round_of_32-1 vs Venc round_of_32-2', 'AT&T Stadium', 'Dallas'),
    ('round_of_16', '2026-07-06 20:00:00', 'Venc round_of_32-3 vs Venc round_of_32-4', 'Estadio Azteca', 'Mexico City'),
    ('round_of_16', '2026-07-07 17:00:00', 'Venc round_of_32-5 vs Venc round_of_32-6', 'SoFi Stadium', 'Los Angeles'),
    ('round_of_16', '2026-07-07 20:00:00', 'Venc round_of_32-7 vs Venc round_of_32-8', 'BC Place', 'Vancouver'),
    ('round_of_16', '2026-07-08 17:00:00', 'Venc round_of_32-9 vs Venc round_of_32-10', 'Hard Rock Stadium', 'Miami'),
    ('round_of_16', '2026-07-08 20:00:00', 'Venc round_of_32-11 vs Venc round_of_32-12', 'Gillette Stadium', 'Boston'),
    ('round_of_16', '2026-07-09 17:00:00', 'Venc round_of_32-13 vs Venc round_of_32-14', 'Mercedes-Benz Stadium', 'Atlanta'),
    ('round_of_16', '2026-07-09 20:00:00', 'Venc round_of_32-15 vs Venc round_of_32-16', 'MetLife Stadium', 'New Jersey'),

    ('quarter', '2026-07-11 17:00:00', 'Venc round_of_16-1 vs Venc round_of_16-2', 'Arrowhead Stadium', 'Kansas City'),
    ('quarter', '2026-07-11 20:00:00', 'Venc round_of_16-3 vs Venc round_of_16-4', 'Levi\'s Stadium', 'San Francisco'),
    ('quarter', '2026-07-12 17:00:00', 'Venc round_of_16-5 vs Venc round_of_16-6', 'SoFi Stadium', 'Los Angeles'),
    ('quarter', '2026-07-12 20:00:00', 'Venc round_of_16-7 vs Venc round_of_16-8', 'BMO Field', 'Toronto'),

    ('semi', '2026-07-14 21:00:00', 'Venc quarter-1 vs Venc quarter-2', 'AT&T Stadium', 'Dallas'),
    ('semi', '2026-07-15 21:00:00', 'Venc quarter-3 vs Venc quarter-4', 'Mercedes-Benz Stadium', 'Atlanta'),

    ('third', '2026-07-18 17:00:00', 'Perdedor semi-1 vs Perdedor semi-2', 'Hard Rock Stadium', 'Miami'),
    ('final', '2026-07-19 17:00:00', 'Vencedor semi-1 vs Vencedor semi-2', 'MetLife Stadium', 'New Jersey'),
]
